# Topic: Recognising and Reporting Phishing Attempts at NC State University
- __Audience:__ New NC State Students
...
Reporting phishing helps protect the entire community. NC State’s Office of Information and Technology (OIT) provides the recommended steps of action after identifying a potential phishing attack.

### Step 1: Check Current Recommended Procedures
Take the steps recommended at the time of the attack. The rest of this task will be written based on the recommended procedures as of 09/13/2026.
...
Click the 3-dot “more” icon in the upper-right corner of the message window
Select “Report Phishing”; the option will have a fishing hook symbol next to it as a visual cue
...
Reach out to your Local IT support or the NC State Help Desk via the NC State IT Service Portal or call 919.515.HELP (4357).
They may ask a variety of questions about the local system to prevent the message from spreading and to ensure additional damage isn’t done. Maintain transparency with the service you reach out to in order to keep yourself and others safe.
If you did provide information through the suspicious email or clicked any links, IT can help you with next steps for how to protect yourself (including things like changing passwords).


### Step 4: Delete the Email

Once all of these steps have been completed and you have properly reported the incident, delete the email to prevent accidental interaction. 
